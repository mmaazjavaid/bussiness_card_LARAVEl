...
<body>
    <div class="login_container">
        ...
        <form class="form_inputs_container" method="POST" action="{{ route('register') }}">
            @csrf
            <div class="headings_container">
                <div class="main_heading">Sign up</div>
                <div class="sub_heading">Please sign up to continue</div>
            </div>
            <div class="form_input_area">
                <div class="email_input">
                    <i class="fa fa-envelope-o" aria-hidden="true"></i>
                    <input id="name" type="text" placeholder="Name"  class=" @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name">
                    @error('name')
